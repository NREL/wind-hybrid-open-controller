...
input_file=amr_precursor_working_1.inp
...
if [ -d "/projects/ssc/ahenry/whoc/amr_precursors/post_processing_0" ]; then
	rm -rf /projects/ssc/ahenry/whoc/amr_precursors/post_processing_1
fi
mkdir /projects/ssc/ahenry/whoc/amr_precursors/post_processing_1
mv ./post_processing/* /projects/ssc/ahenry/whoc/amr_precursors/post_processing_1
