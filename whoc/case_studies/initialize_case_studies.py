...
case_studies = {
    ...
    "wind_preview_type": {"controller_class": {"group": 0, "vals": ["MPC"]},
                          ...
                          "case_names": {"group": 1, "vals": [
                                                            ...
                                                            "Perfect", "Persistent", ]},
                        "max_std_dev": {"group": 1, "vals": [1.5] * 2 * 5 + [2] * 5 + [2, 2]},
                        "decay_type": {"group": 1, "vals": ["exp"] * 5 + ["cosine"] * 5 + ["none"] * 5 + ["none", "none"]},
                        "n_wind_preview_samples": {"group": 1, "vals": [3, 5, 7, 9, 15] * 2 + [25, 50, 100, 250, 500] + [1, 1]},
                        "diff_type": {"group": 1, "vals": ["chain_cd"] * 2 * 5 + ["direct_fd"] * 5 + ["chain_cd", "chain_cd"]},
