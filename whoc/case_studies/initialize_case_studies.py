...
case_studies = {
    ...
    "slsqp_solver_sweep": {"seed": {"group": 0, "vals": [0]},
                            "controller_class": {"group": 0, "vals": ["MPC"]},
                            "wind_preview_type": {"group": 1, "vals": ["stochastic_sample"] * 5 + ["stochastic_interval"] * 20},
                            "n_wind_preview_samples": {"group": 1, "vals": [25, 50, 100, 200, 300] + [1, 3, 5, 7, 9] * 4},
                            "diff_type": {"group": 1, "vals": ["none"] * 5 + ["direct_cd"] * 5 + ["direct_fd"] * 5 + ["chain_cd"] * 5 + ["chain_fd"] * 5},
    ...
    "stochastic_sample_sweep": {"seed": {"group": 0, "vals": [0]},
                            ...
                            #  "nu": {"group": 2, "vals": [0.001, 0.01]},
                              ...
                              "nu": {"group": 4, "vals": [0.001, 0.0001, 0.01]},
                            #   "dt": {"group": 0, "vals": [15]},
...
case_families = ["baseline_controllers", "solver_type",
                    ...
                    "solver_type_test", "stochastic_sample_sweep"]
