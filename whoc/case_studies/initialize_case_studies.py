...
case_studies = {
    ...
    "wind_preview_type": {"controller_class": {"group": 0, "vals": ["MPC"]},
                          ...
                          "case_names": {"group": 1, "vals": [
                                                            "Stochastic Interval Elliptical 3", "Stochastic Interval Elliptical 5", "Stochastic Interval Elliptical 11", "Stochastic Interval Elliptical 15", "Stochastic Interval Elliptical 25", 
                                                            "Stochastic Interval Rectangular 3", "Stochastic Interval Rectangular 5", "Stochastic Interval Rectangular 11", "Stochastic Interval Rectangular 15", "Stochastic Interval Rectangular 25",
    ...
    "cost_func_tuning": {"controller_class": {"group": 0, "vals": ["MPC"]},
                         "case_names": {"group": 1, "vals": [f"alpha_{np.round(f, 3)}" for f in list(np.concatenate([np.linspace(0, 0.8, int(N_COST_FUNC_TUNINGS//2)), 0.801 + (1-np.logspace(-3, 0, N_COST_FUNC_TUNINGS - int(N_COST_FUNC_TUNINGS//2)))*0.199, [1]]))]},
                         "alpha": {"group": 1, "vals": list(np.concatenate([np.linspace(0, 0.8, int(N_COST_FUNC_TUNINGS//2)), 0.801 + (1-np.logspace(-3, 0, N_COST_FUNC_TUNINGS - int(N_COST_FUNC_TUNINGS//2)))*0.199, [1]]))},
                         "floris_input_file": {"group": 0, "vals": [os.path.join(os.path.dirname(whoc_file), 
                                                                        f"../examples/mpc_wake_steering_florisstandin/floris_gch_{9}.yaml")]},
                        "lut_path": {"group": 0, "vals": [os.path.join(os.path.dirname(whoc_file), 
                                                                        f"../examples/mpc_wake_steering_florisstandin/lookup_tables/lut_{9}.csv")]},
