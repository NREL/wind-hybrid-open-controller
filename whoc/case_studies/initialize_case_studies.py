...
case_studies = {
    ...
    "slsqp_solver_sweep": {"seed": {"group": 0, "vals": [0]},
                            ...
                            "wind_preview_type": {"group": 1, "vals": ["stochastic_interval"] * 5 + ["stochastic_sample"] * 5},
                            "n_wind_preview_samples": {"group": 1, "vals": [1, 3, 5, 7, 9, 25, 50, 100, 250, 500]},
                            "nu": {"group": 2, "vals": [10**x for x in range(-3, -1, 1)]},
                            "diff_type": {"group": 3, "vals": ["custom_cd", "custom_fd"]},
                            "use_filtered_wind_dir": {"group": 4, "vals": [False, False]},
