...
def test_LookupBasedWakeSteeringController():
    ...
    test_controller = LookupBasedWakeSteeringController(
        interface=test_interface, input_dict=test_hercules_dict, df_yaw=df_opt_test
    )
...
def test_BatteryController():
    ...
    test_controller_1 = BatteryController(
        test_interface, test_hercules_dict, {"clipping_thresholds": clipping_threshold_1}
    )
    ...
    test_controller_2 = BatteryController(
        test_interface, test_hercules_dict, {"clipping_thresholds": clipping_threshold_2}
    )
...
def test_HydrogenPlantController():
    ...
    controller_gain = (
        test_hercules_dict["controller"]["nominal_plant_power_kW"]
