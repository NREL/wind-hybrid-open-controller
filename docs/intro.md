...
We anticipate that, in future, multiple levels of attribution may be useful 
when defining top-level controllers that operate hybrid power plants with 
various different assets (i.e. hierarchical control).
This situation is shown below, and we intend to support such usage of Hycon.
